<%@ Control Language="C#" AutoEventWireup="true" Inherits="MenuControl2l" Codebehind="MenuControl2l.ascx.cs" %>
<script language="javascript" type="text/javascript">
var webpath="https://www.peptechcorp.com/";
function fillhome()
{
document.homepage.src=webpath+"home1.gif";
}
function removehome()
{
document.homepage.src=webpath+ "images/home.gif";
}


function fillcompany()
{
document.company.src=webpath+"images/company1.gif";
}
function removecompany()
{
document.company.src=webpath+"images/company.gif";
}

function fillservices()
{
document.services.src=webpath+"images/services1.gif";
}
function removeservices()
{
document.services.src=webpath+"images/services.gif";
}

function fillproducts()
{
document.products.src=webpath+"images/products1.gif";
}
function removeproducts()
{
document.products.src=webpath+"images/products.gif";
}

function filloperations()
{
document.operations.src=webpath+"images/operations1.gif";
}
function removeoperations()
{
document.operations.src=webpath+"images/operations.gif";
}

function fillstudies()
{
document.studies.src=webpath+"images/case-studies1.gif";
}
function removestudies()
{
document.studies.src=webpath+"images/case-studies.gif";
}
</script>
...
/*!!!!!!!!!!! QuickMenu Styles [Please Modify!] !!!!!!!!!!!*/
	...
	{	
		...
		background-image:url(qmimages/gradient_27.gif);
		border-width:0px;
		border-style:solid;
		border-color:#5A5372;
	}
...
<script type="text/javascript">if (!window.qmad){qmad=new Object();qmad.binit="";qmad.bvis="";qmad.bhide="";}</script><!--[END-QZ]--> 
	...
	<script type="text/JavaScript"> 
		...
		a.ibcss_main_size = 1;
		a.ibcss_main_bg_color = "#10316B";
		a.ibcss_main_bg_color_hover = "#10316B";
		a.ibcss_main_border_color = "#10316B";
		a.ibcss_main_border_color_hover = "#10316B";
		...
		a.ibcss_sub_bg_color_active = "White";
		a.ibcss_sub_border_color = "White";
		a.ibcss_sub_border_color_active = "White";
...
<li class="qmclear">&nbsp;</li></ul> --%><!-- Create Menu Settings: (Menu ID, Is Vertical, Show Timer, Hide Timer, On Click (options: 'all' * 'all-always-open' * 'main' * 'lev2'), Right to Left, Horizontal Subs, Flush Left, Flush Top) --><script type="text/javascript">qm_create(0,false,0,500,false,false,false,false,false);</script><!--[END-QM0]-->
