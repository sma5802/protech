<%@ Control Language="C#" AutoEventWireup="true" Inherits="menucontrol" Codebehind="menucontrol.ascx.cs" %>
<script language="javascript" type="text/javascript">
function fillhome()
{
    document.homepage.src = "images/home1.gif";
}
function removehome()
{
    document.homepage.src="images/home.gif";
}
function fillcompany()
{
    document.company.src="images/company1.gif";
}
function removecompany()
{
    document.company.src="images/company.gif";
}
function fillservices()
{
    document.services.src="images/services1.gif";
}
...
{
    document.products.src="images/products1.gif";
}
function removeproducts()
{
    document.products.src="images/products.gif";
}

function filloperations()
{
    document.operations.src="images/operations1.gif";
}
function removeoperations()
{
    document.operations.src="images/operations.gif";
}
function fillstudies()
{
    document.studies.src="images/case-studies1.gif";
}
function removestudies()
{
    document.studies.src="images/case-studies.gif";
}
</script> 
<style type="text/css">
