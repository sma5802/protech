<%@ Control Language="C#" AutoEventWireup="true" CodeFile="menucontrolbottom.ascx.cs" Inherits="_menucontrolbottom" %>
...
<script type="text/javascript">qm_create(0,false,0,500,false,true,true,false,true);</script><!--[END-QM0]-->
</div>