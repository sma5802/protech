<%@ Control Language="C#" AutoEventWireup="true" CodeFile="menucontroltop.ascx.cs" Inherits="_menucontroltop" %>
...
<script type="text/javascript">if (!window.qmad){qmad=new Object();qmad.binit="";qmad.bvis="";qmad.bhide="";}</script><!--[END-QZ]--> 
	...
	<script type="text/JavaScript"> 
		...
		a.ibcss_main_size =1;
		a.ibcss_main_bg_color = "black";
		a.ibcss_main_bg_color_hover = "black";
		a.ibcss_main_border_color = "black";
		a.ibcss_main_border_color_hover = "black";
		a.ibcss_main_position_x = 50;
...
<script type="text/javascript">qm_create(0,false,0,500,false,true,false,false,false);</script><!--[END-QM0]-->
</div>