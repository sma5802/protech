<%@ Control Language="C#" AutoEventWireup="true" CodeFile="menucontrolright.ascx.cs" Inherits="_menucontrolright" %>
...
<script type="text/javascript">qm_create(0,true,0,500,false,true,false,false,false);</script><!--[END-QM0]-->
</div>