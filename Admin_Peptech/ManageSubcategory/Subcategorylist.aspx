<%@ Page Language="C#" MasterPageFile="~/Admin_Peptech/Admin.master" AutoEventWireup="true" Inherits="Admin_Peptech_ManageSubcategory_Subcategorylist" Codebehind="Subcategorylist.aspx.cs" %>
...
<p class="tip"><img src="../../images/tip.gif" border="0" align="absmiddle"> Click on a Sub Category to edit the Sub Category name</p>
...
<ItemTemplate>
<asp:HyperLink ID="lblcountiesname1" runat="server" Text='<%#HttpUtility.HtmlDecode(Eval("subcategoryname").ToString()) %>'  ></asp:HyperLink>
</ItemTemplate>
<ItemStyle HorizontalAlign="Left" />
<HeaderStyle HorizontalAlign="Left" />
</asp:TemplateField>
...
<HeaderStyle HorizontalAlign="Left" />
<ItemTemplate>
<asp:HyperLink ID="hypedit" runat="server"  NavigateUrl='<%# "EditSubcategory.aspx?id="+ Eval("id")%>' ImageUrl="../../images/edit.gif" BorderStyle="None"></asp:HyperLink>
</ItemTemplate>  
</asp:TemplateField>
...
SelectCommand="Select s.*,(select categoryname from peptech_category where id=s.categoryid)categoryname  from Peptech_subcategory s ORDER BY id desc"
DeleteCommand="delete Peptech_subcategory where id=@id" >
</asp:SqlDataSource>
<table>
<tr>
