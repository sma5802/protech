<%@ Page Language="C#" MasterPageFile="~/Admin_Peptech/Admin.master" AutoEventWireup="true" Inherits="Admin_Peptech_ManageCategory_CategoryList" Codebehind="CategoryList.aspx.cs" %>
...
<p class="tip"><img src="../../images/tip.gif" border="0" align="absmiddle"> Click on a Category to edit the Category name</p>
...
<HeaderStyle HorizontalAlign="Left" />
<ItemTemplate>
<asp:HyperLink ID="hypedit" runat="server"  NavigateUrl='<%# "EditCategory.aspx?id="+ Eval("id")%>' ImageUrl="../../images/edit.gif" BorderStyle="None"></asp:HyperLink>
</ItemTemplate>  
</asp:TemplateField>
...
SelectCommand="Select *  from Peptech_category ORDER BY id desc"
DeleteCommand="delete Peptech_category where id=@id" >
</asp:SqlDataSource>
<table>
<tr>
