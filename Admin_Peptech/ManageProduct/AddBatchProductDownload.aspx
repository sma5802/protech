<%@ Page Language="C#" MasterPageFile="~/Admin_Peptech/Admin.master" AutoEventWireup="True" Inherits="Admin_Peptech_ManageProduct_AddBatchProduct" Codebehind="AddBatchProductDownload.aspx.cs" %>
...
<%--<asp:Button ID="btnTransfer" runat="server" CssClass="button" Text="Transfer" OnClick="btnTransfer_Click" />--%>
...
<PagerStyle  HorizontalAlign="Center" />
    ...
    <%--<asp:HiddenField ID="hfexcelcount" runat="server" />--%>
</td>
</tr>
</table>
 </asp:Panel>
