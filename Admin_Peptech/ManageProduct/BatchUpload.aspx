<%@ Page Language="C#" MasterPageFile="~/Admin_Peptech/Admin.master" AutoEventWireup="true" EnableViewState="true" Inherits="Admin_Peptech_ManageProduct_BatchUpload" Codebehind="BatchUpload.aspx.cs" %>
...
--%></td>
  ...
  <asp:GridView ID="GridView1" runat="server" CssClass="grid" AllowPaging="true" PageSize="50" Width="80%" EnableSortingAndPagingCallbacks="True" OnPageIndexChanging="GridView1_PageIndexChanging">
