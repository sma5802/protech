<%@ Page Language="C#" MasterPageFile="~/Admin_Peptech/Admin.master" AutoEventWireup="True" Inherits="Admin_Peptech_ManageProduct_AddProduct" Codebehind="AddProduct.aspx.cs" %>
...
<asp:DropDownList id="ddlCategory" runat="server" ValidationGroup="insertcategory" AutoPostBack="True" OnSelectedIndexChanged="ddlCategory_SelectedIndexChanged"></asp:DropDownList>
 <asp:RequiredFieldValidator id="RequiredFieldValidator5" runat="server" 
        ValidationGroup="insertcategory" ErrorMessage="Please Choose Category Name" 
        ControlToValidate="ddlCategory" Display="None" SetFocusOnError="True"></asp:RequiredFieldValidator> </TD></TR>
 <TR><TD style="WIDTH: 17%" vAlign=middle align=left>
 <asp:Label id="Label5" runat="server" Text="SubCategory Name:" Font-Bold="true"></asp:Label> </TD><TD style="WIDTH: 83%" vAlign=middle align=left>
         <asp:DropDownList id="ddlSubCategory" runat="server" ValidationGroup="insertcategory"></asp:DropDownList> 
...
<td align="left" valign="middle">
 <asp:DataList ID="DataList1" runat="server" Width="20%" RepeatColumns="5" 
...
<asp:TextBox ID="txtProduct" runat="server"  ValidationGroup="insertcategory" Width="200" MaxLength="200"></asp:TextBox>
 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtProduct"
        ErrorMessage="Please Enter Product Name" ValidationGroup="insertcategory" 
   ...
   <%-- <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="txtPrice" ErrorMessage="Please Enter Service Price in Numeric Format" ValidationGroup="insertcategory" Display="None" Operator="DataTypeCheck" Type="Currency"></asp:CompareValidator>--%>
    ...
    <tr>
        ...
        <asp:TextBox ID="txtCAS" runat="server" MaxLength="50" 
    ...
    <tr>
        ...
        <td align="left" style="width: 83%" valign="middle">
        <asp:TextBox ID="txtFormula" runat="server" MaxLength="50" 
                ValidationGroup="insertcategory"></asp:TextBox>
       <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtFormula"
        ErrorMessage="Please Enter Formula" ValidationGroup="insertcategory" 
                Display="None" SetFocusOnError="True"></asp:RequiredFieldValidator>
    ...
    <tr>
        ...
        <td align="left" style="width: 83%" valign="middle">
        <asp:TextBox ID="txtWeight" runat="server" MaxLength="15" 
                ValidationGroup="insertcategory"></asp:TextBox>
        ...
        ErrorMessage="Please Enter Molecular Weight" ValidationGroup="insertcategory" 
           ...
           <%-- <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Please enter molecular weight in correct format" ValidationGroup="insertcategory" Display="None" ControlToValidate="txtWeight" Type="Double"></asp:RangeValidator>--%>
            <asp:CompareValidator ID="CompareValidator1" runat="server" 
                ControlToValidate="txtWeight" Display="None" 
                ErrorMessage="Molecular weight must be in numeric form" 
                Operator="DataTypeCheck" SetFocusOnError="True" Type="Double" 
                ValidationGroup="insertcategory"></asp:CompareValidator>
        </td>
    </tr>
     <tr>
       ...
       <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="fuPImage"
        ErrorMessage="Please Enter Product Image" ValidationGroup="insertcategory" 
                Display="None" SetFocusOnError="True"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <%-- <tr>
