<%@ Page Language="C#" MasterPageFile="~/Admin_Peptech/Admin.master" AutoEventWireup="true" Inherits="Admin_Peptech_Order_Vieworder" Codebehind="Vieworder.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<asp:Panel ID="Panel1" runat="server" Width="600px" CssClass="text">
<br />
...
--%>
<asp:HyperLink ID="hyprint" runat="server">Print</asp:HyperLink>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:window.history.back(-1)'>Back</a>
<br />
<br />
<asp:Label ID="lblMsg" runat="server" Visible="false" EnableViewState="false" Font-Bold="true" ForeColor="Red"></asp:Label><br />
