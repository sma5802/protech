<%@ Page Language="C#" MasterPageFile="~/Admin_Peptech/Admin.master" Debug="true" AutoEventWireup="true" Inherits="Admin_Peptech_ViewQuoteRequest" Codebehind="ViewQuoteRequest.aspx.cs" %>
...
<asp:Panel ID="Panel1" runat="server" GroupingText='<%# "Quote Request Information of " + Eval("name") %>'>   
<table width="100%" >
<tr>
<td align="left" valign="middle"  >
...
<tr>
<td align="left" valign="middle"  >
<asp:Label ID="Label11" runat="server" Text="Product Name:" Font-Bold="true"></asp:Label>
</td>
<td align="left" valign="middle">
<asp:Label ID="Label12" runat="server" Text='<%#Eval("productname")%>'></asp:Label>
</td>
</tr>

<tr>
<td align="left" valign="middle"  >
<asp:Label ID="Label27" runat="server" Text="Catalog Number :" Font-Bold="true"></asp:Label>
</td>
<td align="left" valign="middle">

    <asp:Label ID="Label28" runat="server" Text='<%#Eval("catalognumber")%>'></asp:Label>
</td>
</tr>

<tr>
<td align="left" valign="middle"  >
<asp:Label ID="Label29" runat="server" Text="CAS Number:" Font-Bold="true"></asp:Label>
</td>
<td align="left" valign="middle">

    <asp:Label ID="Label30" runat="server" Text='<%#Eval("casnumber")%>'></asp:Label>
</td>
</tr>

<tr>
<td align="left" valign="middle"  >
<asp:Label ID="Label31" runat="server" Text="Quantity:" Font-Bold="true"></asp:Label>
</td>
<td align="left" valign="middle">

    <asp:Label ID="Label32" runat="server" Text='<%#Eval("quantity")%>'></asp:Label>
</td>
</tr>

<tr>
<td align="left" valign="middle"  >
<asp:Label ID="Label33" runat="server" Text="Purity:" Font-Bold="true"></asp:Label>
</td>
<td align="left" valign="middle">

    <asp:Label ID="Label34" runat="server" Text='<%#Eval("purity")%>'></asp:Label>
</td>
</tr>

<tr>
<td align="left" valign="middle"  >
<asp:Label ID="Label35" runat="server" Text="Date:" Font-Bold="true"></asp:Label>
</td>
<td align="left" valign="middle">

    <asp:Label ID="Label36" runat="server" Text='<%#Eval("dateneed")%>'></asp:Label>
</td>
</tr>
...
SelectCommand="select (ri.fname+' '+ri.Lname) as name,ri.*,(select country from peptech_country where id=ri.country)countryname,(select state from peptech_state where id=ri.state)statename from Peptech_RequestInfo ri order by posteddate desc">
</asp:SqlDataSource>--%>
...
<asp:SqlDataSource ID="bindgrid" runat="server"
ConnectionString="<%$ ConnectionStrings:dbConnect %>"
SelectCommand="select (ri.fname+' '+ri.Lname) as name,ri.*,(select country from peptech_country where id=ri.country)countryname,isnull((select state from peptech_state where id=ri.state),other)statename from Peptech_RequestInfo ri where Enquirytype='Quote Request' order by posteddate desc"
 >
</asp:SqlDataSource>
</td>
</tr>
