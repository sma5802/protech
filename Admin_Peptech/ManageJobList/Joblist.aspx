<%@ Page Language="C#" MasterPageFile="~/Admin_Peptech/Admin.master" AutoEventWireup="true" Inherits="Admin_Peptech_ManageJobList_Joblist" Codebehind="Joblist.aspx.cs" %>
...
<p class="tip"><img src="../../images/tip.gif" border="0" align="absmiddle"> Click on a Jobs to edit the Jobs Detail</p>
...
<asp:TemplateField HeaderText="JobPosition">
<ItemTemplate>
<asp:Label ID="lblHeadlines" runat="server" Text='<%#Eval("JobPosition") %>'></asp:Label>
</ItemTemplate>
<ItemStyle HorizontalAlign="Left" />
<HeaderStyle HorizontalAlign="Left" />
</asp:TemplateField>
...
<ItemTemplate>
<asp:Label ID="lblHeadlines1" runat="server" Text='<%#Eval("Location") %>'></asp:Label>
</ItemTemplate>
<ItemStyle HorizontalAlign="Left" />
<HeaderStyle HorizontalAlign="Left" />
</asp:TemplateField>
...
<HeaderStyle HorizontalAlign="Left" />
<ItemTemplate>
<asp:HyperLink ID="hypedit" runat="server"  NavigateUrl='<%#"Editjob.aspx?id="+ Eval("id")%>' ImageUrl="../../images/edit.gif" BorderStyle="None"    ></asp:HyperLink>
</ItemTemplate>  
</asp:TemplateField>
...
SelectCommand="Select *  from Peptech_jobs ORDER BY id asc"
DeleteCommand="delete Peptech_jobs where id=@id" >
</asp:SqlDataSource>
<table>
<tr>
