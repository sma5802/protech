<%@ Page Language="C#" MasterPageFile="~/Admin_Peptech/Admin.master" AutoEventWireup="true" Inherits="Admin_Peptech_ManageNews_NewsList" Codebehind="NewsList.aspx.cs" %>
...
<h2>Manage News Releases</h2>
<asp:Label ID="lblmessage" runat="server" CssClass="msg" Visible="False"></asp:Label>
<p class="tip"><img src="../../images/tip.gif" border="0" align="absmiddle"> Click on a News to edit the News Detail</p>
...
<ItemTemplate>
<asp:Label ID="lblHeadlines" runat="server" Text='<%#Eval("headlines") %>'></asp:Label>
</ItemTemplate>
<ItemStyle HorizontalAlign="Left" />
<HeaderStyle HorizontalAlign="Left" />
</asp:TemplateField>
...
<HeaderStyle HorizontalAlign="Left" />
<ItemTemplate>
<asp:HyperLink ID="hypedit" runat="server"  NavigateUrl='<%#"EditNews.aspx?id="+ Eval("id")%>' ImageUrl="../../images/edit.gif" BorderStyle="None"    ></asp:HyperLink>
</ItemTemplate>  
</asp:TemplateField>
...
SelectCommand="Select *  from Peptech_news ORDER BY postdate asc"
DeleteCommand="delete Peptech_news where id=@id" >
</asp:SqlDataSource>
<table>
<tr>
