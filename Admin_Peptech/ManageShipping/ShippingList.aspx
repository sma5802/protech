<%@ Page Language="C#" MasterPageFile="~/Admin_Peptech/Admin.master" AutoEventWireup="true" Inherits="Admin_Peptech_ManageShipping_ShippingList" Codebehind="ShippingList.aspx.cs" %>
...
<p class="tip"><img src="../../images/tip.gif" border="0" align="absmiddle"> Click on a Shipping to edit the Shipping name</p>
...
<ItemTemplate>
<asp:HyperLink ID="lblcountiesname" runat="server" ></asp:HyperLink>
</ItemTemplate>
<ItemStyle HorizontalAlign="Left" />
<HeaderStyle HorizontalAlign="Left" />
</asp:TemplateField>
...
<ItemTemplate>
<asp:HyperLink ID="lblcountiesname1" runat="server" Text='<%#Eval("service") %>'  ></asp:HyperLink>
</ItemTemplate>
<ItemStyle HorizontalAlign="Left" />
<HeaderStyle HorizontalAlign="Left" />
</asp:TemplateField>
...
<ItemTemplate>
<asp:HyperLink ID="lblPrice" runat="server"></asp:HyperLink>
</ItemTemplate>
<ItemStyle HorizontalAlign="Left" />
<HeaderStyle HorizontalAlign="Left" />
</asp:TemplateField>
...
<HeaderStyle HorizontalAlign="Left" />
<ItemTemplate>
<asp:HyperLink ID="hypedit" runat="server"  NavigateUrl='<%# "EditShipping.aspx?id="+ Eval("id")%>' ImageUrl="../../images/edit.gif" BorderStyle="None"></asp:HyperLink>
</ItemTemplate>  
</asp:TemplateField>
...
SelectCommand="Select * from Peptech_shipping ORDER BY location asc"
DeleteCommand="delete Peptech_shipping where id=@id" >
</asp:SqlDataSource>
<table>
<tr>
