<%@ Page Language="C#" MasterPageFile="~/Admin_Peptech/Admin.master" AutoEventWireup="true" ValidateRequest="false" Inherits="Admin_Peptech_CMS_CMSList"  Codebehind="CMSList.aspx.cs"  %>
...
<p class="tip"><img src="../../images/tip.gif" border="0" align="absmiddle"> Click on a CMS PageName to View/Edit.</p>

<%--<asp:Button ID="btnadd" Text="Add New" runat="server" CssClass="button" OnClick="btnadd_Click" />--%>



<asp:GridView ID="grdcms" Width="100%" CssClass="grid" DataSourceID="srccms" 
        DataKeyNames="id" AllowPaging="true" PageSize="20"  AutoGenerateColumns="false" 
...
<br />
 ...
 <asp:Label ID="Label1" runat="server" Text="From" Visible="false"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtfrom" runat="server" Visible="false"></asp:TextBox><br />
...
SelectCommand="select id,pagename from peptech_edit where home=0">
</asp:SqlDataSource>
