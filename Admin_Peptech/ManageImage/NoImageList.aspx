<%@ Page Language="C#" MasterPageFile="~/Admin_Peptech/Admin.master" AutoEventWireup="true" Inherits="Admin_Peptech_ManageImage_NoImageList" Title="Untitled Page" Codebehind="NoImageList.aspx.cs" %>
...
<div align="right"><a href="ImageList.aspx"><strong>Show all Products</strong></a></div><br />
...
<HeaderStyle HorizontalAlign="Left" />
<ItemTemplate>
<asp:HyperLink ID="hypedit" runat="server"  NavigateUrl='<%# string.Format("EditImage.aspx?id={0}&image=no", Eval("id"))%>' ImageUrl="../../images/edit.gif" BorderStyle="None"></asp:HyperLink>
</ItemTemplate>  
</asp:TemplateField>
...
from pep$tech$corp.Peptech_Product p where p.ProductImage is null or p.ProductImage='' ORDER BY categoryname,subcategoryname,productname asc"
