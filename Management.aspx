<%@ Page Language="C#" MasterPageFile="~/Content.master" AutoEventWireup="true" Inherits="Management" Codebehind="Management.aspx.cs" %>
          ...
          <tr align="left" valign="top">
            <td><table width="100%"  border="0" cellpadding="10" cellspacing="0" class="text">
              <tr align="left" valign="top">
                <td>
                <br />
                <a href="company.aspx" class="blueheading1">Mission and History</a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<strong class="blueheading">Management</strong>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href="facility.aspx" class="blueheading1">Facilities</a>
                </td>
              </tr>
            </table>
            <table width="100%"  border="0" cellpadding="10" cellspacing="0" class="text">
                  <tr>
                    <td align="left" valign="top"><%--<a href="default.aspx" class="bluelink">Home</a> &gt; <a href="company.aspx" class="bluelink">Company</a> &gt; Management<br />--%>
                        <asp:Label ID="lblcmsManagement" runat="server"></asp:Label>                </td>
                  </tr>
              </table></td>
